...
<body>
  ...
  <h4>بِسْمِ ٱللَّٰهِ ٱلرَّحْمَٰنِ ٱلرَّحِيمِ</h4></marquee>
  <style>
h4 {text-align: center;}
div {text-align: center;}
</style>
  <marquee><h5>Developed By Tareq</h5></marquee>
    <header>Download Thumbnail</header>
    <div class="url-input">
      <span class="title">Paste video url:</span>
      <div class="field">
        <input type="text" placeholder="https://www.youtube.com/watch?v=JnX7Oc8LqD8" required>
